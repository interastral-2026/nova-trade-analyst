            ...
            return (
              ...
              >
                ...
                <div className="grid grid-cols-4 gap-2 mb-4">
                  ...
                  <div className="bg-indigo-500/[0.03] border border-indigo-500/10 p-2.5 rounded-xl text-center shadow-inner">
                    <p className="text-[7px] text-indigo-500 uppercase font-black mb-1">Time</p>
                    <p className="text-[10px] font-black text-indigo-400 truncate">{signal.estimatedTimeMinutes || "?"}m</p>
                  </div>
                </div>
