          ...
          activeSignals.map((signal) => {
            ...
            return (
              ...
              >
                ...
                {(signal.liquidityAnalysis || signal.marketMonitoring) && (
                  <div className="mt-2 space-y-1 pt-2 border-t border-white/5">
                    {signal.liquidityAnalysis && (
                      <div className="flex items-start space-x-1.5">
                        <i className="fas fa-droplet text-cyan-500 text-[6px] mt-0.5"></i>
                        <p className="text-[7px] text-slate-500 leading-tight font-medium" dir="auto">
                          {signal.liquidityAnalysis}
                        </p>
                      </div>
                    )}
                    {signal.marketMonitoring && (
                      <div className="flex items-start space-x-1.5">
                        <i className="fas fa-eye text-amber-500 text-[6px] mt-0.5"></i>
                        <p className="text-[7px] text-slate-500 leading-tight font-medium" dir="auto">
                          {signal.marketMonitoring}
                        </p>
                      </div>
